...
// ErrorCannotFindBookInfo is used when the bookInfo with the given ID cannot be found on the underlying data source
type ErrorCannotFindBookInfo struct {
	ID string
}

func (e *ErrorCannotFindBookInfo) Error() string {
